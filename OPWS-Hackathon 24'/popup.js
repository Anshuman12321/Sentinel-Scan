document.addEventListener('DOMContentLoaded', () => {
    ...
    // Shows the Sign Up prompt and hides the signIn whenever the user wants to sign up
    document.getElementById('showSignUp').addEventListener('click', () => {
        document.getElementById('signInContainer').style.display = 'none';
        document.getElementById('signUpContainer').style.display = 'block';
    });
    // Shows the Sign In prompt and hides the signUp whenever the user wants to sign in
    ...
    // Shows the options available to the user after the questionnaire/profile details for the user
    document.getElementById('submit').addEventListener('click', () => {
        document.getElementById('questionnaire').style.display = 'none';
        document.getElementById('status').style.display = 'block';
    });
    // Shows the questionnaire  prompt and hides the status page whenever the user wants to edit their profile details
    ...
    document.getElementById('optimizeback').addEventListener('click', () => {
